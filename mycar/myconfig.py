...
# import os
# many iterations, when given a positive integer.
# CAMERA
...
#NETWORK_JS_SERVER_IP = "192.168.0.19"#when listening for network joystick control, which ip is serving this information
...
MODEL_CATEGORICAL_MAX_THROTTLE_RANGE = 0.30
# 
# #RNN or 3D
